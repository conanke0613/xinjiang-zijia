...
(function() {
    ...
    var DAYS = [
        { d:1,  c:"武汉",     lat:30.7928, lng:114.4055 },   // ① 起点（略偏东北，与⑰错开）
        { d:2,  c:"西安",     lat:34.2658, lng:108.9541 },
        { d:3,  c:"武威",     lat:37.9282, lng:102.6365 },
        { d:4,  c:"哈密",     lat:42.9384, lng:93.6156  },    // ④ 入疆哈密（与⑭错开）
        ...
        { d:14, c:"哈密",     lat:42.7584, lng:93.3856  },    // ⑭ 返程哈密（向西南偏移）
        { d:15, c:"张掖",     lat:38.9384, lng:100.4519 },
        { d:16, c:"兰州",     lat:36.0657, lng:103.8260 },
        { d:17, c:"武汉✈️",   lat:30.3928, lng:114.2055 }     // ⑰ 终点飞回家（略偏西南）
    ];
